...
//NOTE: Prompt returns the value entered as a string (in case the user enters 1 or "1" in a string). That is why double equals == instead of triple === (strict equality) here. 
if (userInput == 1) {
    userInput = prompt (q2);
